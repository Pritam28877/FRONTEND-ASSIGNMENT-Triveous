...
const Card = ({ data, enabled }) => {
  ...
  return (
    <div
      ...
      className={` ${
        enabled
          ? "w-[150px] sm:w-[280px] md:w-[230px] lg:w-[300px] 2xl:w-[350px]"
          : "w-full md:w-[400px] lg:w-[500px] xl:w-[600px]"
      } flex flex-col items-start justify-start rounded-2xl shadow-lg mx-2 my-2 bg-slate-200 p-2 card`}
    >
      ...
      <h1 className="text-xs text-center md:text-sm my-2 w-full italic">
        Open, Read, Save
      </h1>
    </div>
  );
